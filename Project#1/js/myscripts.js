...
window.onload = function(){
    ...
    myTitle.innerHTML = "Toronto Maple Leafs";

    var imageContainer = document.querySelector("#logo");    
    var logoImageStr = "<img alt='" + logoImage.alt + "'" + " src='" + logoImage.url + "'" + " height='" + logoImage.height + "'/>";
    imageContainer.innerHTML = logoImageStr;

    var listTitle = document.querySelector("#list");
    listTitle.innerHTML = "Player List";
    ...
    for(var i=0; i < players.length; i++){ 
            ...
            "<td>" + "<img alt='" + players[i].nationCode + "' src='photo/country/" + players[i].nationCode + ".png' width='50' height='25' />"  + "</td>" +
